...
import {
    ...
    unescapeAttr,
    escapeHtml,
    serializeMemories as _serializeMemories,
    mergeMemoryBlocks,
...
// Pure functions (parseMemories, countMemories, escapeAttr, unescapeAttr, escapeHtml,
// serializeMemories, mergeMemoryBlocks, migrateMemoriesIfNeeded, detectFileFormat,
// convertHeuristic, truncateText, reindexEditingSet) are in lib.js.
...
/** Settings-aware wrapper around lib.js serializeMemories. */
function serializeMemories(blocks, formatOverride) {
    return _serializeMemories(blocks, formatOverride || getFormatOptions());
}
...
// truncateText is imported from lib.js
...
// escapeHtml is imported from lib.js
...
// reindexEditingSet is imported from lib.js
